...
if(isset($_POST['update'])){
   ...
   if($old_pass != $empty_pass){
      ...
      $message[] = 'Porfavor, ingresa la contraseña antigua.';
   }
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="password" name="confirm_pass" placeholder="Ingresa de nuevo la nueva contraseña" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
