...
if(isset($_POST['add_product'])){
   ...
   if($select_product->rowCount() > 0){
      ...
      if($image_size > 2000000){
         $message[] = 'El tamaño de la imagen es muy pesada.';
      }else{
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         ...
         <a href="admin_products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('¿Desea eliminar este producto?');">Eliminar</a>
      </div>
   </div>
   <?php
         }
